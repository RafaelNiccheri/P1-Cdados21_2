...
class RemoveWords:
    def __init__(self, dataframe, column_name, product_name, show_removed=False):
        """
        :param product_name: name of the chosen product to guarantee it wont be removed
    ...
    def remove_at(self):
        ...
        for elements in data2.keys():
            ...
            elif elements == self.product_name:
                keep_dic[elements] = data2[elements]
            elif '@' in elements:
...
def main():
    try:
        ...
        #
        #     mn
        #     print(qremove_options['# de ocorrências']['ps5'], qremove_num_str['# de ocorrências']['ps5'])
        #
        #     print(f"""{qremove_link['# de ocorrências']['ps5']} qremove_link
        #     {qremove_at['# de ocorrências']['ps5']} qremove_at
        #     {qremove_ponc['# de ocorrências']['ps5']} qremove_ponc
        #     {qremove_word_st3['# de ocorrências']['ps5']} qremove_word_st3
        #     {qremove_laugh['# de ocorrências']['ps5']} qremove_laugh
        #     {qremove_num_str['# de ocorrências']['ps5']} qremove_num_str""")
        #
        ...
        at_character = RemoveWords(p, '# de ocorrências', 'ps5', show_removed=True)
        link = RemoveWords(p, '# de ocorrências', 'ps5', show_removed=True)
        ponc = RemoveWords(p, '# de ocorrências', 'ps5', show_removed=True)
        word_sts = RemoveWords(p, '# de ocorrências', 'ps5', show_removed=True)
        laugh = RemoveWords(p, '# de ocorrências', 'ps5', show_removed=True)
        num_str = RemoveWords(p, '# de ocorrências', 'ps5', show_removed=True)
        options = RemoveWords(p, '# de ocorrências', 'ps5', show_removed=True)
        ...
        print(f"""NUMERO DE VEZES QUE A PERECE A PALAVRA PS5 POR DATAFRAME CRIDO (VALE LEMBRAR QUE O DATAFRAME
            ...
            {qremove_link['# de ocorrências']['ps5']} qremove_link, num ps5
            {qremove_at['# de ocorrências']['ps5']} qremove_at, num ps5
            {qremove_ponc['# de ocorrências']['ps5']} qremove_ponc, num ps5
            {qremove_word_sts['# de ocorrências']['ps5']} qremove_word_sts, num ps5
            {qremove_laugh['# de ocorrências']['ps5']} qremove_laugh, num ps5
            {qremove_num_str['# de ocorrências']['ps5']} qremove_num_str, num ps5
            {qremove_options['# de ocorrências']['ps5']} qremove_options, num ps5""")
